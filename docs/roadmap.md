...
## v1.9 — Конфиг и файловая система
...
- [ ] директория templates. css и js заготовки. можно подключать к странице через конфиг-файл
- [ ] опциональный параметр в конфиге - отображение положения пользователя. как в проводнике windows. нужно дорисовать UI для этого
