...
- [ ] - в первую очередь сделать кэширование изображений
- [ ] - и добавить queryParam, чтото типа width=240,height=200 - при запросе статики, берется картинка из локального кэша. если её там нет - создается и кэшируется
- [ ] - hidden скидывать на низ. разделить с основными resources deviderом ("hidden") сделать уже по вертикали - прям высоту 80px
- [ ] добавь api-роуты и queryparam в документацию. например ?static - точно нужно добавлять
- [ ] также добавь роут для создания резервной копии. хочу при помощи курла получать архив со своими uploads
